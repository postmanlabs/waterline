...
function createValues(valuesObject, cb) {
  ...
  // @todo - temporarily adding transaction ID back from valuesObject.originalValues
  valuesObject.originalValues.transactionId &&
    (valuesObject.values.transactionId = valuesObject.originalValues.transactionId);

...
module.exports = {
  ...
  findOne: function(criteria, cb, _transactionID) {
    var self = this;
    ...
    if(typeof cb !== 'function') {
      return new Deferred(this, this.findOne, (_transactionID && (criteria.transactionID = _transactionID), criteria));
    }
  ...
  find: function(criteria, options, cb, _transactionID) {
    var self = this;
    ...
    // Return Deferred or pass to adapter
    if(typeof cb !== 'function') {
      return new Deferred(this, this.find, (_transactionID && (criteria.transactionID = _transactionID), criteria),
        options);
    }
